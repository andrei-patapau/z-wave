...
XS(boot_Device__SerialPort)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXSproto_portable("Device::SerialPort::Bits::get_hash", XS_Device__SerialPort__Bits_get_hash, file, "");
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
